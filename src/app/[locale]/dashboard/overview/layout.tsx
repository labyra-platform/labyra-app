    ...
    <PageContainer>
      <div className='flex flex-1 flex-col space-y-2'>
        <div className='flex items-center justify-between'>
          <h2 className='text-2xl font-bold tracking-tight'>{tCommon('welcomeBack')}</h2>
        </div>
        ...
        <div className='*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs md:grid-cols-2 lg:grid-cols-4'>
          <Card className='@container/card'>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              <div className='line-clamp-1 flex gap-2 font-medium'>
                {t('trendingUpMonth')} <Icons.trendingUp className='size-4' />
              </div>
          ...
          <Card className='@container/card'>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              <div className='line-clamp-1 flex gap-2 font-medium'>
                {t('trendingDownPeriod')} <Icons.trendingDown className='size-4' />
              </div>
          ...
          <Card className='@container/card'>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              <div className='line-clamp-1 flex gap-2 font-medium'>
                {t('strongRetention')} <Icons.trendingUp className='size-4' />
              </div>
          ...
          <Card className='@container/card'>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              <div className='line-clamp-1 flex gap-2 font-medium'>
                {t('steadyIncrease')} <Icons.trendingUp className='size-4' />
              </div>
