...
export const Icons = {
  ...
  experiments: IconFlask2,
  spectra: IconWaveSine,
  dataAssets: IconDatabase,
  lineage: IconHierarchy,
  chemicals: IconBottle,
  equipment: IconMicroscope,
  bookings: IconCalendarEvent,
  members: IconUsers,
  papers: IconFileText,
  manuscripts: IconWriting,
  references: IconQuote,
  spectralStandards: IconCards,
  protocol: IconChecklist,
  computation: IconCpu,
  protocolTemplates: IconTemplate,
  studio: IconBrush,
  ...
  evals: IconChecklist,
  costDrift: IconTrendingUp,
  // Papers domain filter (R181)
  field: IconCategory2,
  domainFilter: IconTags,
  pdfFile: PdfFileIcon
};
